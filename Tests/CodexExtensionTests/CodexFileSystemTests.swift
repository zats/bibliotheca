...
struct CodexFileSystemTests {
    ...
    func listsHiddenRestoreArtifacts() throws {
        ...
        let hiddenURL = rootURL.appending(path: ".codex-extension-restore-backup-test.app", directoryHint: .isDirectory)
    ...
    func replacesDirectoryItemInPlace() throws {
        ...
        let stagedURL = rootURL.appending(path: ".codex-extension-restore/Codex.app", directoryHint: .isDirectory)
        let backupName = ".codex-extension-restore-backup-test.app"
