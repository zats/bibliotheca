...
struct CodexOnboardingPlanTests {
    ...
    func cleanCodexWithDisabledExtensionsActivatesPatch() {
        let snapshot = BibliothecaSetupSnapshot(
    ...
    func actionTitlesComeFromHeadlessActionModel() {
        #expect(BibliothecaSetupRecommendedAction.openCodexDownloadPage.buttonTitle == "Download")
        #expect(BibliothecaSetupRecommendedAction.selectCodexApp.buttonTitle == "Select")
        #expect(BibliothecaSetupRecommendedAction.installExtensionStore.buttonTitle == "Prepare")
        #expect(BibliothecaSetupRecommendedAction.openAppManagementSettings.buttonTitle == "Allow")
        #expect(BibliothecaSetupRecommendedAction.quitCodex.buttonTitle == "Quit")
        #expect(BibliothecaSetupRecommendedAction.patchCodex.buttonTitle == "Patch")
        #expect(BibliothecaSetupRecommendedAction.launchCodex.buttonTitle == "Launch Codex")
    }
