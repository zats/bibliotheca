...
struct OnboardingSettingsPane: View {
    @State private var session = BibliothecaSetupSession()
    ...
    private func run(_ action: BibliothecaSetupRecommendedAction) {
        Task {
...
struct PermissionsSection: View {
    ...
    let action: BibliothecaSetupRecommendedAction
    @Binding var appManagementButtonFrame: CGRect
    let runAction: (BibliothecaSetupRecommendedAction) -> Void
...
struct OnboardingStepRow: View {
    ...
    let isActive: Bool
    let action: BibliothecaSetupRecommendedAction?
    let inProgressAction: BibliothecaSetupRecommendedAction?
    let errorMessage: String?
    @Binding var appManagementButtonFrame: CGRect
    let runAction: (BibliothecaSetupRecommendedAction) -> Void
    let clearError: () -> Void
    ...
    @ViewBuilder
    private func frameReader(for action: BibliothecaSetupRecommendedAction) -> some View {
        if action == .openAppManagementSettings {
