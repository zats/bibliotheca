...
public struct CodexOnboardingPlan: Equatable, Sendable {
    ...
    public var activeAction: BibliothecaSetupRecommendedAction?
    public var errorMessage: String?

    public init(snapshot: BibliothecaSetupSnapshot?, errorMessage: String?) {
...
public enum BibliothecaSetupActionOutcome: Equatable, Sendable {
    case completed
    case requiresCodexAppSelection
    case failed(String)
}

extension BibliothecaSetupRecommendedAction {
...
extension CodexOnboardingPlan {
    private static func steps(from snapshot: BibliothecaSetupSnapshot?) -> [CodexOnboardingStep] {
    ...
    private static func codexDetail(_ snapshot: BibliothecaSetupSnapshot) -> String {
    ...
    private static func patchDetail(_ snapshot: BibliothecaSetupSnapshot) -> String {
    ...
    private static func patchStatus(_ snapshot: BibliothecaSetupSnapshot) -> CodexOnboardingStepStatus {
        if !snapshot.extensionStoreStatus.exists || !snapshot.extensionStoreStatus.requiredExtensionsEnabled {
            return .needsAction
        }
    ...
    private static func updateDetail(_ snapshot: BibliothecaSetupSnapshot) -> String {
    ...
    private static func updateStatus(_ snapshot: BibliothecaSetupSnapshot) -> CodexOnboardingStepStatus {
    ...
    private static func readyDetail(_ snapshot: BibliothecaSetupSnapshot) -> String {
    ...
    private static func readyStatus(_ snapshot: BibliothecaSetupSnapshot) -> CodexOnboardingStepStatus {
    ...
    private static func actionDetail(_ action: BibliothecaSetupRecommendedAction) -> String {
        switch action {
        case .openCodexDownloadPage:
    ...
    private static func permissionDetail(_ snapshot: BibliothecaSetupSnapshot) -> String {
    ...
    private static func permissionStatus(_ snapshot: BibliothecaSetupSnapshot) -> CodexOnboardingStepStatus {
    ...
    private static func isProvisionedLaunchState(_ snapshot: BibliothecaSetupSnapshot) -> Bool {
    ...
    private static func runningDetail(_ snapshot: BibliothecaSetupSnapshot) -> String {
        snapshot.isCodexRunning ? "Running" : "Closed"
    }

    private static func runningStatus(_ snapshot: BibliothecaSetupSnapshot) -> CodexOnboardingStepStatus {
