...
public struct BibliothecaStoreStatus: Equatable, Sendable {
...
public enum BibliothecaSetupRecommendedAction: Equatable, Sendable {
...
public struct CodexUpdateRepatchPolicy: Sendable {
    public static func plan(for snapshot: BibliothecaSetupSnapshot) -> CodexUpdateRepatchPlan {
...
public struct BibliothecaSetupSnapshot: Equatable, Sendable {
    ...
    public var extensionStoreStatus: BibliothecaStoreStatus
    public var latestCodexUpdate: CodexUpdateInfo?
    public var recommendedAction: BibliothecaSetupRecommendedAction
    ...
    public init(
        ...
        isCodexRunning: Bool,
        extensionStoreStatus: BibliothecaStoreStatus,
        latestCodexUpdate: CodexUpdateInfo?,
        recommendedAction: BibliothecaSetupRecommendedAction
    ) {
        self.appURL = appURL
...
struct BibliothecaSetupConfiguration: Sendable {
...
enum BibliothecaSetupError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .appManagementPermissionRequired:
            "Enable App Management for Bibliotheca in Privacy & Security, then retry."
        case .codexStillRunning:
